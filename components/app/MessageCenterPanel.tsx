  ...
  return (
    <div className={`absolute top-[4.45rem] right-3 z-40 w-[min(94vw,24rem)] max-h-[72vh] rounded-lg border shadow-2xl flex flex-col overflow-hidden animate-[breathe_0.25s_ease-out] ${bgClass}`}>
      ...
      <div className={`flex items-center justify-between px-4 py-3 border-b ${borderClass}`}>
        ...
        <div className="flex items-center gap-2">
          {unreadCount > 0 && (
            <span className={`px-2 py-0.5 rounded text-[10px] font-mono border ${pillClass}`}>
                ...
                <div className="flex items-start justify-between gap-3 p-3">
                  ...
                  >
                    <div className="flex items-center gap-2 flex-wrap">
                      <span
                        className={`inline-flex items-center gap-1 rounded px-2 py-1 text-[10px] font-mono font-bold border ${
                          alert.isRead
                    ...
                    <p className={`mt-2 line-clamp-3 pr-2 text-sm leading-6 ${textClass}`}>
                      {alert.preview}
                    </p>
                  </button>
      ...
      <div className={`px-4 py-2 border-t flex items-center justify-between text-[10px] font-mono ${isDarkMode ? 'bg-black/40 border-yellow-900/30' : 'bg-gray-50 border-gray-200'}`}>
