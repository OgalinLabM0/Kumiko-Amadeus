...
| 世界书 + 本地 RAG | 稳定设定 + 语义回想 | 三层 Tier + `bge-m3-onnx` + HNSW + BM25 + RRF |
...
教学中 `0.40` 概率触发**忙碌短回复**（"啊，现在在上课，等下说！"），然后 10-30 分钟后主动跟进补回。
...
- 三层 Tier 世界书（高优先级用户覆盖 / 官方角色设定 / 普通自定义）+ 关键词驱动的召回 Lore
