...
// ... existing UI_TRANSLATIONS ...
  zh: {
    ...
    updateMobileHint: "Android 通过 GitHub Releases 检查新版本。点击「打开下载页」会跳转到浏览器下载新 APK，下载完成后从通知栏点开手动安装即可。",
    updateOpenDownloadPage: "打开下载页",
    ...
    ttsSpeed: "语速",
    ttsSpeedRestore: "恢复 1.0",
    ttsSpeedOutOfRangeHint: "建议保持在 0.7 ~ 1.5 区间，过快会让久美子的语调失真。",
    ttsLatency: "延迟模式",
  ...
  en: {
    ...
    updateMobileHint: "Android checks for new versions via GitHub Releases. Tap \"Open Download Page\" to jump to your browser, download the latest APK, then install it from your downloads / notification shade.",
    ...
    ttsSpeed: "Speed",
    ttsSpeedRestore: "Reset to 1.0",
    ttsSpeedOutOfRangeHint: "Recommended range is 0.7 – 1.5x; faster values make Kumiko's intonation noticeably warped.",
